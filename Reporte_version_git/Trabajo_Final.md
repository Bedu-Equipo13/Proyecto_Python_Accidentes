...
```
    ...
    <ipython-input-1-ba4e8709bb4d> in <module>
    ----> 1 Tendencia_años=df_cdmx_filtrado.groupby('ID_EDAD')['ANIO'].value_counts()
    

    NameError: name 'df_cdmx_filtrado' is not defined
...
```
    ...
    <ipython-input-2-99a70cecbdfc> in <module>
    ----> 1 Tendencia_30_años=Tendencia_años.loc[30].sort_index(ascending=True)
          2 Tendencia_30_años
    

    NameError: name 'Tendencia_años' is not defined
